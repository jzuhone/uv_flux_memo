...
the form of polymerized contaminant resulting from the UV fluence from all solar system objects is $N_{\rm C} = 3.25 \times 10^{18}$~cm$^{-2}$, $\sim$44\% of the areal density of the contaminant present at the center of OBFs. We find that
...
Finally, we consider the fluence accumulated over the lifetime of the mission from the local UV background.
