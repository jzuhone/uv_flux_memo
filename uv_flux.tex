...
molecule. Assuming $n_{\rm C} = 24$ for dioctyl phthalate, $N_{\rm C} = 8.11 \times 10^{16}$~cm$^{-2}$, which is a small
fraction of the areal density of the contaminant present on the OBFs (Figure \ref{fig:areal_density}).
...
as above, we find $N_{\rm C} = 2.19 \times 10^{17}$~cm$^{-2}$, slightly higher than the predicted amount resulting from
