...
density of C corresponding to the amount of polymerized contaminant, assuming 100\% efficiency. Using the same formalism as above, we find $N_{\rm C} = 2.19 \times 10^{17}$~cm$^{-2}$, $\sim$3\% of the areal density of the contaminant present at the center of OBFs, which is slightly higher than the predicted amount resulting from the bright Earth.
